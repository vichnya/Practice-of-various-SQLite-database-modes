...
u1 = User(101, 1.60, 'user101', 0, '2022-03-02 14:51:21')
u2 = User(102, 1.75, 'user 102', 0, '2022-03-02 14:51:21')

db_connection = Connection()
db_connection2 = Connection()

print(f'С помощью Singleton сохраняем первый экземпляр класса в качестве атрибута. Проверка: {id(db_connection)} = {id(db_connection2)}')